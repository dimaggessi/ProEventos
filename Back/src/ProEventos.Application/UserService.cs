    ...
    public class UserService : IUserService
    {
        ...
        public async Task<SignInResult> CheckUserPasswordAsync(UserUpdateDto userUpdateDto, string password)
        {
            try
            {
                var user = await _userManager.Users
                                             ...
                                             == userUpdateDto.UserName.ToLower());
                
                return await _SignInManager.CheckPasswordSignInAsync(user, password, false); //false para não bloquear
            }
        ...
        public async Task<UserUpdateDto> GetUserByUserNameAsync(string userName)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                throw new Exception($"Erro ao procurar usuário pelo Username. Erro: {ex.Message}");
            }
        }
