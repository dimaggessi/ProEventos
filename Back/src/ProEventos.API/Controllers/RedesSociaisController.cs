    ...
    public class RedesSociaisController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetByEvento(int eventoId)
        {
            ...
            catch (Exception ex)
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError,
                    $"Erro ao tentar recuperar redes social por evento. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> SaveByEvento(int eventoId, RedeSocialDto[] models)
        {
            ...
            catch (Exception ex)
            {
                ...
                return this.StatusCode(StatusCodes.Status500InternalServerError,
                    $"Erro ao tentar salvar a(s) rede social(is). Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> DeleteByEvento(int eventoId, int redeSocialId)
        {
            try
            {
                ...
                return await _redeSocialService.DeleteByEvento(eventoId, redeSocialId)
                        ...
                        : throw new Exception("Ocorreu um problema ao tentar excluir rede social por evento");
            }
            catch (Exception ex)
            {

                return this.StatusCode(StatusCodes.Status500InternalServerError,
                    $"Erro ao tentar remover rede social por evento. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> DeleteByPalestrante(int redeSocialId)
        {
            try
            {
                ...
                return await _redeSocialService.DeleteByPalestrante(palestrante.Id, redeSocialId)
                        ? Ok(new {message = "Rede social excluída"})
                        : throw new Exception("Ocorreu um problema ao tentar excluir rede social por palestrante");
            }
            catch (Exception ex)
            {

                return this.StatusCode(StatusCodes.Status500InternalServerError,
                    $"Erro ao tentar remover rede social por palestrante. Erro: {ex.Message}");
            }
        }
